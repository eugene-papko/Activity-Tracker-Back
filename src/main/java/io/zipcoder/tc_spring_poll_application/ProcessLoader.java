...
public class ProcessLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Button but1 = new Button(1234235445L, user1.getId(), "Running");
        Button but2 = new Button(23456645345L, user1.getId(), "Walking with Dog");
        Button but3 = new Button(34555654678L, user1.getId(), "Learning Java");
        buttonRepository.save(but1);
        buttonRepository.save(but2);
        buttonRepository.save(but3);
...
//        }});
        ...
        buttonRepository.save(new Button(92512323445L, user2.getId(), "Sleeping"));
